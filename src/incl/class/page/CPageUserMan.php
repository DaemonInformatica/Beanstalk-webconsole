<?php
include_once("CPageAdmin.php");
include_once("incl/class/logic/CLogicUserMan.php");

class CPageUserMan extends CpageAdmin
{
  ...
  function __construct($envs)
  {
    ...
    CPageAdmin::__construct($envs, $arrAccessReq);
  }

public function createTop()
  {
    $code  = "";
    $code .= "<div class=\"righttop\">\n";
    $code .= "  <h1>Gebruikers management</h1>\n";
    $code .= "</div><!--end of righttop-->\n";
  ...
  public function createUserList()
  {
    ...
    */
    ...
    $code .= "<table border=\"1\">\n";
    $code .= "  <tr class=\"tbtitel\"><td>ID:</td><td>NAAM:</td><td>USERNAME:</td><td>EMAIL:</td><td>STATUS:</td><td>GROEP:</td><td>IP:</td><td>CREATED:</td><td>UPDATED:</td><td>CREATED BY:</td><td>UPDATED BY:</td><td>OPTIES:</td></tr>\n";
    ...
    for($i = 0; $i < $lenUsers; $i++)
    {
      ...
      $state      = $pUser->getValue("state") == "active" ? "Active" : "Inactive";
      ...
      $code .= "  <td>\n";
      $code .= "    <a href=\"adm_users.php?cid=10&uid=$id\"><img src=\"pics/admin/edit.gif\" alt=\"edit\" /></a>\n";
      $code .= "    \n";
      $code .= "    <a href=\"adm_users.php?cid=20&uid=$id\"><img src=\"pics/admin/delete.gif\" alt=\"block\" /></a>\n";
      $code .= "  </td>\n";
      $code .= "</tr>\n";
    }
    $code .= "</table>\n";
  ...
  public function createEditUser()
  {
    ...
    $newState = $state    == "blocked" || $state == "regsitered"  ? 1           : 0;
  ...
  {
    $userID     = $_GET['uid'];
    $state      = $_GET['state'] == 1 ? "active" : "blocked";
    $updatedBy  = $this->getUserID();
