...
class CPageGroupMan extends CPageAdmin
{
...
public function createTop()
  ...
  public function createGroupsList()
  {
    ...
    $code      .= "<span class=\"poleft\">Huidige groepen:</span><br><br>\n";
    $code      .= "<table border=\"1\">\n";
    $code      .= "  <tr class=\"tbtitel\"><td>id:</td><td>NAAM:</td><td>CREATED:</td><td>UPDATED:</td><td>CREATED BY:</td><td>UPDATED BY:</td><td>OPTIES:</td></tr>\n";
    ...
    for($i = 0; $i < $lenGroups; $i++)
    {
      ...
      $code .= "  <td>";
      $code .= "    <a href=\"adm_groups.php?cid=20&grid=$id\"><img src=\"pics/admin/edit.gif\" alt=\"edit\" /></a>";
      $code .= "     - ";
      $code .= "    <a href=\"adm_groups.php?cid=30&grid=$id\"><img src=\"pics/admin/delete.gif\" alt=\"block\" /></a>";
      $code .= "  </td>";
      $code .= "</tr>";
    }
