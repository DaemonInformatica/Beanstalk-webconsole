...
class CPageLanguageMan extends CPageAdmin
{
  ...
  public function buildLanguageTable()
  {
    ...
    <table border="1">
      ...
      for($i = 0; $i < $keySetLength; $i++)
      {
        ...
        print("<td>$keyName</td>");
        // Show option to edit.
        print("<td><a href=\"adm_langman.php?cid=10&kid=$keyName\"><img src=\"pics/admin/edit.gif\" alt=\"edit\" /></a></td>\n");
		// for each language:
